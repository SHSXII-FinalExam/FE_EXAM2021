...
public class RiwayatSiswaAdapter extends RecyclerView.Adapter<RiwayatSiswaAdapter.ViewHolder> {
    private final Context context;
    private final List<Transaksi> transaksi;

    public RiwayatSiswaAdapter(Context context, List<Transaksi> transaksi) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.cardView.setCardBackgroundColor(ContextCompat.getColor(context, R.color.colorCyan));
